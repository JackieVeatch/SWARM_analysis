...
load '/Volumes/T7_Shield/jmv208/ACROBAT/LCS_obs_null.mat'
...
% Data to be tested
data = LCS_obs_null.rand_ftle_patch_avg;
...
% Data to be tested
data = LCS_obs_null.obs_ftle_patch_avg;
...
% Data for two groups
group1 = LCS_obs_null.rand_ftle_patch_avg;
group2 = LCS_obs_null.obs_ftle_patch_avg;

% Perform Wilcoxon rank sum test
[p_value, h] = ranksum(group1, group2, 'tail', 'left');
% 'left' for one-sided test where group1 < group2, 'left' for group1 < group2
...
% Data to be tested
data = LCS_obs_null.rand_ftle_edge_avg;
...
% Data to be tested
data = LCS_obs_null.obs_ftle_edge_avg;
...
% Data for two groups
group1 = LCS_obs_null.rand_ftle_edge_avg;
group2 = LCS_obs_null.obs_ftle_edge_avg;

% Perform Wilcoxon rank sum test
[p_value, h] = ranksum(group1, group2, 'tail', 'left');
% 'left' for one-sided test where group1 < group2
...
% Data to be tested
data = LCS_obs_null.rand_rpd_patch_avg;
...
% Data to be tested
data = LCS_obs_null.obs_rpd_patch_avg;
...
% Data for two groups
group1 = LCS_obs_null.rand_rpd_patch_avg;
group2 = LCS_obs_null.obs_rpd_patch_avg;
...
% Data to be tested
data = LCS_obs_null.rand_rpd_edge_avg;
...
% Data to be tested
data = LCS_obs_null.obs_rpd_edge_avg;
...
% Data for two groups
group1 = LCS_obs_null.rand_rpd_edge_avg;
group2 = LCS_obs_null.obs_rpd_edge_avg;

% Perform Wilcoxon rank sum test
[p_value, h] = ranksum(group1, group2, 'tail', 'left');
% left tail ==> group 1 < group 2
...
% Data for two groups
group1 = LCS_obs_null.diff_ftle_patch;
group2 = LCS_obs_null.diff_ftle_edge;
...
% Data for two groups
group1 = LCS_obs_null.diff_ftle_strat_edge;
group2 = LCS_obs_null.diff_ftle_strat_patch;
...
% Data for two groups
group1 = LCS_obs_null.diff_ftle_mixed_patch;
group2 = LCS_obs_null.diff_ftle_mixed_edge;
...
% Data for two groups
group1 = LCS_obs_null.diff_ftle_mixed_edge;
group2 = LCS_obs_null.diff_ftle_strat_edge;
